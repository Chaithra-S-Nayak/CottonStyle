...
const Faq = () => {
  ...
  return (
    <div className={`${styles.section} my-8 min-h-screen`}>
      ...
      <div className="mx-auto space-y-4">
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept payments via Razorpay, which includes UPI, Visa,
                MasterCard, and other methods. Additionally, we offer a cash on
                delivery option.
              </p>
            </div>
          )}
