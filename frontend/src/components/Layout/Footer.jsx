...
import visa from "../../Assests/v.png";
import mastercard from "../../Assests/m.png";
import upi from "../../Assests/u.png";
import cod from "../../Assests/d.png";
      ...
      <div className="container mx-auto py-12 px-4 ">
        <div className="flex flex-col md:flex-row justify-between items-start mb-8 ">
          <div className="md:w-1/3 mb-4 md:mb-0 flex flex-col ">
            <Link to="/" className="mb-4">
              <img src={logo} alt="CottonStyle" className="w-24" style={{ filter: "brightness(0) invert(1)" }}/>
            </Link>
            <p>Discover the latest trends in t-shirt fashion and express yourself with our premium collection.</p>
          ...
          <div className="md:w-1/3 mb-4 md:mb-0 flex flex-col items-center justify-center">
            ...
            <ul>
              <li className="mb-2 mx-10"><Link to="/products" className="hover:text-teal-400">Products</Link></li>
              <li className="mb-2 mx-10"><Link to="/about" className="hover:text-teal-400">About Us</Link></li>
              <li className="mb-2 mx-10"><Link to="/contact" className="hover:text-teal-400">Contact Us</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="md:w-1/2 text-center md:text-left mb-4 md:mb-0">
            ...
            <p><Link to="/terms" className="hover:text-teal-400">Terms</Link> · <Link to="/privacy" className="hover:text-teal-400">Privacy Policy</Link></p>
          </div>
