const styles = {
  ...
  heading: 'text-[20px] text-center md:text-start font-[400] font-Roboto pb-[20px]',
  ...
  button: "w-[170px] bg-[#243450] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
  cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#243450] flex items-center justify-center cursor-pointer",
