...
const textLineSchema = new mongoose.Schema({
  ...
  fontSize: {
    type: Number,
    required: [true, "Please enter font size for the line!"],
  },
  fontStyle: {
    type: String,
    required: [true, "Please enter font style for the line!"],
  },
...
const bannerSchema = new mongoose.Schema({
  imageUrl: {
    type: String,
    required: [true, "Please enter image URL for the banner!"],
  },
...
const themeSchema = new mongoose.Schema({
  primaryColor: {
    type: String,
    required: [true, "Please enter primary color for the theme!"],
  },
  secondaryColor: {
    type: String,
    required: [true, "Please enter secondary color for the theme!"],
  },
});
